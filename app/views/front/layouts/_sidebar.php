<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Dunia Dalam Berita<span>Suka Halaman</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Dunia Dalam Berita<span>Follow kami</span></a></li>
            <li><a href="#"><i class="fa fa-youtube-play"></i>Dunia Dalam Berita<span>Subscribe</span></a></li>
         </ul>
      </aside>

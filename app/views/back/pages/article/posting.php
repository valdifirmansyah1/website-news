         ...
         <div class="modal-body">
            <form action="#" class="form-horizontal" id="form">
               ...
               <div class="form-group row">
                  ...
                  <div class="col">
                     <label for="choice" class="col-form-label">Pilihan Editor</label>
                  ...
                  <div class="col">
                     <label for="thread" class="col-form-label">Berita Popular</label>
               ...
               <div class="form-group row">
                  <label class="col-sm-2 col-form-label" id="label-photo"><span class="text-danger">*</span> Upload Foto </label>
                  <div class="col-sm-10">
